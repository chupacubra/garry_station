...
SKIN.PrintName		= "GMod 98"
SKIN.Author		= "AwesomeGraczGie21"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "gwenskin/gmodskin98.png" )
...
SKIN.tex.Scroller = {}
SKIN.tex.Scroller.Checker 				= Material("gui/gmod98checker.png", "noclamp alphatest")
...
function SKIN:PaintVScrollBar( panel, w, h )
	...
	surface.SetMaterial(self.tex.Scroller.Checker)
...
derma.DefineSkin( "GMod98", "Made to look like Windows 98", SKIN )
